...
If you want to use the certs generated by Rancher server you will need to configure your Ingress to enable SSL pass-through.

#### Pass-through: RKE install
...
#### Pass-through: nginx-ingress from Helm Chart
...
```shell
helm install rancher/rancher --name rancher --namespace rancher-system \
--set tls=rancher \
